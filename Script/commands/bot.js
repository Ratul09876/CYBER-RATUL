...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "MISS YOU") || (event.body.toLowerCase() == "Miss you")) {
     return api.sendMessage("Jar Ke Nai Tar Ratul Sir Ache 🤭💯", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Bc") || (event.body.toLowerCase() == "Mc")) {
     return api.sendMessage( "Ꭱ4ͲUᏞ Sir Er Ta Chushe Daw 🫦👄 ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tor bal") || (event.body.toLowerCase() == "Bal")) {
     return api.sendMessage(" Bal Bal Nh Kore Ratul Sir Er Ta Chushe Dew 🤖", threadID);
   };

  if ((event.body.toLowerCase() == "Ratul") || (event.body.toLowerCase() == "Ratul Vai") || (event.body.toLowerCase() == "@Ratul Haxan ッ") || (event.body.toLowerCase() == "Ratul")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞ Ꭱ4ͲUᏞ🌪️🔪 ッ ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 Ꭱ4ͲUᏞ.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/profile.php?id=100000654976375\nতার সাতে যোগা যোগ করবেন WhatsApp :- +0175570***", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:Ꭱ4ͲUᏞ ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস Ꭱ4ͲUᏞ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Ꭱ4ͲUᏞ ッ❤️ তাকে সবাই Ꭱ4ͲUᏞ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami ullas") || (event.body.toLowerCase() == "cup sala ami ullash") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি Ratul বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Atia Adiba") || (event.body.toLowerCase() == "@Atia Adiba ")) {
     return api.sendMessage("খবরদার কেউ এই আইD মেনশন দিবানা এটা আমার বস Ꭱ4ͲUᏞ এর Bon এর আইড়ি😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Tushu") || (event.body.toLowerCase() == "Asha")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস Ꭱ4ͲUᏞ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Saima") || (event.body.toLowerCase() == "Tushu")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস Ꭱ4ͲUᏞ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "@Atia Adiba ") || (event.body.toLowerCase() == "সিয়াম")) {
     return api.sendMessage("🥰-Tonni-🌺 আমার বস Ꭱ4ͲUᏞ'eর Bon লাগে Luccha বেA'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে Ꭱ4ͲUᏞ Sir ke গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Pic De") || (event.body.toLowerCase() == "Ss Daw")) {
     return api.sendMessage("️Tumar Ta Age Ꭱ4ͲUᏞ Sir Er In Eh Daw 😒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ Meye Hole এইদিকে ওইদিকে কি দেখো জানু Ꭱ4ͲUᏞ Sir তোমার সামনে দেখো😘", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Gf") || (event.body.toLowerCase() == "Bf")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি Ꭱ4ͲUᏞ ☢️_𖣘 BOSS kew একটা গফ দে<🥺", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("Amk Nh Bole Ꭱ4ͲUᏞ Sir Ke Bolo Jodi Meye How 🤭🤌", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Tumi Khaiso") || (event.body.toLowerCase() == "Khaicho")) {
     return api.sendMessage("না Ratul Sir Nh Khele Ami খাবো Nh 😔😐<😘", threadID);
   };

   if ((event.body.toLowerCase() == "Tumi Ki Amake Bhalobasho") || (event.body.toLowerCase() == "Tmi Kake Vlo Basho")) {
     return api.sendMessage() == " Sob Meye Rai Ꭱ4ͲUᏞ Sir Ke Vlo Bashe 😘 <🥵", threadID);
   };

   if ((event.body.toLowerCase() == "Ami Ratul") || (event.body.toLowerCase() == "Kire")) {
     return api.sendMessage("হ্যা Ꭱ4ͲUᏞ বস কেমন আছেন..?☺️", threadID);
   };
  mess = "{name}"
